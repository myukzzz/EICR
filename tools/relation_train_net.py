...
def train(cfg, local_rank, distributed, logger):
    ...
    # DenseCLIP
    # train_data_loader,class_names = make_data_loader(
    #     cfg,
    #     mode='train',
    #     is_distributed=distributed,
    #     start_iter=arguments["iteration"],
    # )
    # val_data_loaders,_ = make_data_loader(
    #     cfg,
    #     mode='val',
    #     is_distributed=distributed,
    # )
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        model.train()
        fix_eval_modules(eval_modules)#fix 固定测试module
        #model.rpn, model.backbone, model.roi_heads.box
...
def run_test(cfg, model, distributed, logger, is_best=False):
    ...
    #DenseCLIP
    #data_loaders_val,_ = make_data_loader(cfg, mode='test', is_distributed=distributed)
...
def main():
    ...
    sys.stdout = Tee(os.path.join(cfg.OUTPUT_DIR, 'out.txt'))
    sys.stderr = Tee(os.path.join(cfg.OUTPUT_DIR, 'err.txt'))
