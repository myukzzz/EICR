...
def main():
    ...
    #os.system(os.path.join(cfg.OUTPUT_DIR, 'out_test_nms_05thersh.txt'))
    #os.system(os.path.join(cfg.OUTPUT_DIR, 'err_test_nms_05thersh.txt'))

    ########myout#############
    sys.stdout = Tee(os.path.join(cfg.OUTPUT_DIR, 'out_causal-09.txt'))
    sys.stderr = Tee(os.path.join(cfg.OUTPUT_DIR, 'err_causal-09.txt'))
